run: main.o mesh.o data_structures.o boundary.o solver.o vtk_export.o numerical_flux.o
	g++ -O3 -o run.out bin/main.o bin/solver.o bin/mesh.o bin/data_structures.o bin/boundary.o bin/vtk_export.o bin/numerical_flux.o -fopenmp
